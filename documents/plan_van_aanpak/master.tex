...
%\input{docs/example}
\input{docs/achtergronden}
\input{docs/projectresultaat}
\input{docs/projectactiviteiten}
\input{docs/projectgrenzen}
\input{docs/tussenresultaten}
\input{docs/kwaliteit}
\input{docs/projectorganisatie}
\input{docs/planning}
\input{docs/kostenbaten}
\input{docs/risicos}
